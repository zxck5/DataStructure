 ...
 * 
 * It is the process of separating each into an independent set.
 * A disjoint set indicates which set each target element is included in by giving it a number.
 * Initializes its own element number to the set it belongs to.
 * 
 * Union (by rank)
 * 
